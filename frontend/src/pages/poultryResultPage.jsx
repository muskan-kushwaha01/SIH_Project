  ...
  const getRiskConfig = (riskLevel) => {
    const configs = {
      Low: {
        ...
        icon: "✓",
        title: "Low Risk",
        subtitle: "Your farm shows good health indicators",
        recommendations: [
          { icon: "🔄", text: "Continue current vaccination schedule", priority: "maintain" },
          { icon: "💧", text: "Maintain clean water supply", priority: "maintain" },
          { icon: "👀", text: "Regular health monitoring", priority: "maintain" },
          { icon: "🛡️", text: "Keep biosecurity measures active", priority: "maintain" }
        ]
      },
      Medium: {
        value: 50,
        ...
        recommendations: [
          { icon: "🧹", text: "Increase cleaning frequency for coops", priority: "urgent" },
          { icon: "🏥", text: "Isolate any sick birds immediately", priority: "urgent" },
          { icon: "🌾", text: "Secure feed storage from pests", priority: "important" },
          { icon: "👁️", text: "Monitor for respiratory symptoms", priority: "important" }
        ]
      },
      High: {
        value: 75,
        ...
        recommendations: [
          { icon: "📞", text: "Contact veterinarian immediately", priority: "critical" },
          { icon: "🚫", text: "Restrict all farm access", priority: "critical" },
          { icon: "🌀", text: "Improve ventilation systems", priority: "urgent" },
          { icon: "🏥", text: "Quarantine affected birds", priority: "urgent" }
        ]
      }
    };
      ...
      try {
        ...
        if (response.ok) {
          ...
          if (response.status === 404) {
            throw new Error('No poultry risk analysis found. Please complete the risk assessment first.');
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-6 xs:mb-8 md:mb-12">
          <h1 className={`${
            ...
            Poultry Farm Risk Assessment Report
          </h1>
          <p className={`text-gray-600 animate-fade-in ${
            isMobile ? 'text-sm xs:text-base' : 'text-lg md:text-xl'
          } font-medium px-3`} style={{animationDelay: '0.3s'}}>
            Comprehensive analysis results for your poultry farm
          </p>
        ...
        <div className={`${
          ...
          <button
            ...
            className={`w-full ${
              !isMobile ? 'sm:w-auto' : ''
            } px-6 xs:px-8 lg:px-10 py-3 xs:py-4 bg-gray-600 text-white rounded-xl hover:bg-gray-700 transition-all duration-300 font-semibold ${
          ...
          <button
            ...
            className={`w-full ${
              !isMobile ? 'sm:w-auto' : ''
            } px-6 xs:px-8 lg:px-10 py-3 xs:py-4 bg-blue-600 text-white rounded-xl hover:bg-blue-700 transition-all duration-300 font-semibold ${
              isMobile ? 'text-sm xs:text-base' : 'text-base sm:text-lg'
            } shadow-lg hover:shadow-xl transform hover:scale-105`}
          >
            🔄 New Analysis
...
export default PoultryRiskResultPage;